    ...
    [5794], {
        86027(t, e, n) {
            ...
            class m extends o.Component {
                static getDerivedStateFromProps(t, e) {
                    ...
                    return !n || o && n.x === o.x && n.y === o.y ? null : ((0, c.default)("Draggable: getDerivedStateFromProps %j", {
                        position: n,
                        prevPropsPosition: o
                    }), {
                        x: n.x,
                ...
                constructor(t) {
                    super(t), h(this, "onDragStart", (t, e) => {
                        if ((0, c.default)("Draggable: onDragStart: %j", e), !1 === this.props.onStart(t, (0, l.createDraggableData)(this, e))) return !1;
                        this.setState({
                            dragging: !0,
                            dragged: !0
                        })
                        ...
                        (0, c.default)("Draggable: onDrag: %j", e);
                ...
                render() {
                    ...
                    return o.createElement(d.default, g({}, m, {
            ...
            e.default = m, h(m, "displayName", "Draggable"), h(m, "propTypes", { ...d.default.propTypes,
            ...
            }), h(m, "defaultProps", { ...d.default.defaultProps,
                axis: "both",
                bounds: !1,
            ...
            class m extends o.Component {
                constructor() {
                    super(...arguments), f(this, "dragging", !1), f(this, "lastX", NaN), f(this, "lastY", NaN), f(this, "touchIdentifier", null), f(this, "mounted", !1), f(this, "handleDragStart", t => {
                        ...
                        if ((0, u.default)("DraggableCore: handleDrag: %j", r), !1 !== this.props.onDrag(t, r) && !1 !== this.mounted) this.lastX = n, this.lastY = o;
                        else try {
                    ...
                    }), f(this, "onMouseDown", t => (h = g, this.handleDragStart(t))), f(this, "onMouseUp", t => (h = g, this.handleDragStop(t))), f(this, "onTouchStart", t => (h = p, this.handleDragStart(t))), f(this, "onTouchEnd", t => (h = p, this.handleDragStop(t)))
                }
                componentDidMount() {
                    this.mounted = !0;
                ...
                componentWillUnmount() {
                    ...
                    if (t) {
                        ...
                        (0, i.removeEvent)(e, g.move, this.handleDrag), (0, i.removeEvent)(e, p.move, this.handleDrag), (0, i.removeEvent)(e, g.stop, this.handleDragStop), (0, i.removeEvent)(e, p.stop, this.handleDragStop), (0, i.removeEvent)(t, p.start, this.onTouchStart, {
                            passive: !1
        ...
        71089(t, e, n) {
            Object.defineProperty(e, "__esModule", {
                ...
                return {
                    x: (t.clientX + e.scrollLeft - o.left) / n,
                    y: (t.clientY + e.scrollTop - o.top) / n
                }
            ...
            }, e.removeClassName = d, e.removeEvent = function(t, e, n, o) {
                if (!t) return;
                const r = {
                    capture: !0,
                    ...o
                ...
                if (t) try {
                    if (t.body && d(t.body, "react-draggable-transparent-selection"), t.selection) t.selection.empty();
                    else {
        ...
        81726(t, e, n) {
            Object.defineProperty(e, "__esModule", {
                ...
                return (0, o.isNum)(i.right) && (e = Math.min(e, i.right)), (0, o.isNum)(i.bottom) && (n = Math.min(n, i.bottom)), (0, o.isNum)(i.left) && (e = Math.max(e, i.left)), (0, o.isNum)(i.top) && (n = Math.max(n, i.top)), [e, n]
