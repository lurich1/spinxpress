/*! For license information please see 9100.4f1636025d5593bd4506.js.LICENSE.txt */
(self.webpackChunkengine = self.webpackChunkengine || []).push([
    [1344, 1820, 2005, 2462, 3523, 3970, 4201, 4378, 4677, 4765, 5629, 6570, 6582, 7058, 8963, 9100, 9439], {
        55103(e, t, r) {
            "use strict";
            r.d(t, {
                Au: () => s,
            ...
            var n = r(38874),
                ...
                y = (0, n.css)(["", ";", ";background:rgba(var(--black),0.12);backdrop-filter:blur(100px);-webkit-backdrop-filter:blur(100px);position:fixed;z-index:4;top:0;left:0;"], o, p),
                m = (0, n.css)(["position:relative;padding:2.5em 0.75em 1em;"]),
        ...
        99100(e, t, r) {
            ...
            var p = (0, n.memo)(o.default.div.withConfig({
                    componentId: "sc-9fp1ae-0"
                })(["flex:1 1 auto;background:var(--globalHistoryBg,linear-gradient(167.28deg,#2a2a2a 0%,#0e0e11 100%));border:1px solid;border-color:var( --globalHistoryBorderColor,rgba(var(--white),0.1) rgba(var(--white),0.2) rgba(var(--white),0.3) );border-radius:var(--globalHistoryRadius,1em);height:100%;width:66.5em;margin-right:1em;padding:var(--globalHistoryPadding,1em);position:absolute;top:0;left:0;z-index:var(--globalHistoryZIndex,3);"])),
                y = {
                    headerCell: {
                        fontSize: "0.75em"
                    },
            ...
            function m(e) {
                ...
                return (0, c.jsx)(p, {
                    style: r.container,
                    ref: n,
                    children: (0, c.jsx)(i.Table, {
                        headers: t.headers,
                        body: t.body,
                        winBy: t.winBy,
                        onSelect: t.onSelect,
                        type: t.type,
                        notWinStrs: t.notWinStrs,
                        styles: b(b({}, y), r.table)
                    })
                })
            }
            m.defaultProps = {
        ...
        23451(e, t, r) {
            ...
            function m(e) {
                var t = e.headers,
                    ...
                    h = (0, n.useMemo)(function() {
                        ...
                        return Array.isArray(r) && ("MultiRow" === o ? r.forEach(function(t) {
                            t.forEach(function(r, n) {
                                ...
                                o.styles = d.row, o.direction = 0 === n ? "top" : n === t.length - 1 ? "bottom" : "center", !r[i] || Number.isNaN(+(0, a.toNumberString)(r.win)) && y.includes(r.win) || (o.styles = g, o.win = +(0, a.toNumberString)(r.win)), 1 === t.length && (o.direction = ""), e.push(o)
                            })
                        }) : e = r.map(function(e) {
                            var t = [];
                            if (void 0 !== e.key) {
                            ...
                            } else "bet" === i && !Number.isNaN(+(0, a.toNumberString)(e.win)) && +(0, a.toNumberString)(e.win) >= +(0, a.toNumberString)(e.bet) && (t.styles = g, t.win = +(0, a.toNumberString)(e.win)), !e[i] || "bet" === i || Number.isNaN(+(0, a.toNumberString)(e.win)) && y.includes(e.win) || (t.styles = g, t.win = +(0, a.toNumberString)(e.win));
                            return t
                        })), e
                    }, [r, o, i]),
                    ...
                    v = (0, n.useMemo)(function() {
                        return (null == h ? void 0 : h.map(function(e, t) {
                            var r = "".concat(e.key, "_").concat(t),
                                ...
                                a = t === f,
                                c = i && e.win;
                            return a && Object.assign(n, m), (0, l.jsx)(s.TableRow, {
                                selected: a,
                                styles: n,
                                win: c,
                    ...
                    j = (0, n.useDeferredValue)(w),
                    x = (0, n.useDeferredValue)(v);
